...
n_train                  = 10;
dim                      = 2;
[xt, yt]                 = getInitialBraninFunctionDataABO(n_train, max_t_train);
[xt, yt]                 = orderData(xt, yt);
[xs, ys]                 = getInitialBraninFunctionDataABO(n_test, max_t_test);
...
settings.true_func          = @(x) branin_func(x);
settings.true_func_bulk     = @(x) branin_func_bulk(x);
...
save('ABO_4.mat', 'traceX', 'traceFunc', 'traceXopt_true', 'traceFopt_true', ...
