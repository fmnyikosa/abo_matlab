...
% Function: Scaled Hartman 6D Function
...
n_test                   = 100;
n_train                  = 10;
[xt, yt]                 = getInitialHart6SCFunctionDataABO(n_train, max_t_train);
[xt, yt]                 = orderData(xt, yt);
[xs, ys]                 = getInitialHart6SCFunctionDataABO(n_test, max_t_test);
...
settings.true_func          = @(x) hart6_sc_func(x);
